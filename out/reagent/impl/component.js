...
reagent.impl.component.do_render = (function do_render(C){var _STAR_current_component_STAR_6100 = reagent.impl.component._STAR_current_component_STAR_;try{reagent.impl.component._STAR_current_component_STAR_ = C;
var f = (C[reagent.impl.component.cljs_render]);var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,f))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"f","f",-1640531425,null))))].join('')))})());var p = reagent.impl.util.js_props.call(null,C);var res = ((((C["componentFunction"]) == null))?f.call(null,C):(function (){var argv = (p[reagent.impl.util.cljs_argv]);var n = cljs.core.count.call(null,argv);var G__6101 = n;if(cljs.core._EQ_.call(null,5,G__6101))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3),cljs.core.nth.call(null,argv,4));
} else
{if(cljs.core._EQ_.call(null,4,G__6101))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2),cljs.core.nth.call(null,argv,3));
} else
{if(cljs.core._EQ_.call(null,3,G__6101))
{return f.call(null,cljs.core.nth.call(null,argv,1),cljs.core.nth.call(null,argv,2));
} else
{if(cljs.core._EQ_.call(null,2,G__6101))
{return f.call(null,cljs.core.nth.call(null,argv,1));
} else
{if(cljs.core._EQ_.call(null,1,G__6101))
{return f.call(null);
} else
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_6100;
}});
reagent.impl.component.custom_wrapper = (function custom_wrapper(key,f){var G__6103 = key;if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUnmount","componentWillUnmount",4147620643),G__6103))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentDidUpdate","componentDidUpdate",4103164189),G__6103))
{return (function (oldprops){var C = this;var old_argv = (oldprops[reagent.impl.util.cljs_argv]);return f.call(null,C,old_argv);
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillUpdate","componentWillUpdate",2086388618),G__6103))
{return (function (nextprops){var C = this;var next_argv = (nextprops[reagent.impl.util.cljs_argv]);return f.call(null,C,next_argv);
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"shouldComponentUpdate","shouldComponentUpdate",3193956709),G__6103))
...
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"componentWillReceiveProps","componentWillReceiveProps",2122862542),G__6103))
{return (function (props){var C = this;return f.call(null,C,(props[reagent.impl.util.cljs_argv]));
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getInitialState","getInitialState",2219830677),G__6103))
{return (function (){var C = this;return reagent.impl.component.set_state.call(null,C,f.call(null,C));
});
} else
{if(cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"getDefaultProps","getDefaultProps",1976256919),G__6103))
{if(false)
{return null;
} else
...
{return (function() { 
var G__6104__delegate = function (args){var C = this;return cljs.core.apply.call(null,f,C,args);
};
...
{var G__6107 = f;(G__6107["__reactDontBind"] = true);
return G__6107;
} else
{return f;
}
...
{var wrap = reagent.impl.component.custom_wrapper.call(null,key,f);if(cljs.core.truth_((function (){var and__3431__auto__ = wrap;if(cljs.core.truth_(and__3431__auto__))
{return f;
} else
...
{}
var or__3443__auto__ = wrap;if(cljs.core.truth_(or__3443__auto__))
...
reagent.impl.component.add_render = (function add_render(fun_map,render_f){return cljs.core.assoc.call(null,fun_map,new cljs.core.Keyword(null,"cljsRender","cljsRender",2584602394),render_f,new cljs.core.Keyword(null,"render","render",4374279432),(cljs.core.truth_(reagent.impl.util.is_client)?(function (){var C = this;return reagent.impl.batching.run_reactively.call(null,C,(function (){return reagent.impl.component.do_render.call(null,C);
}));
}):(function (){var C = this;return reagent.impl.component.do_render.call(null,C);
})));
});
reagent.impl.component.wrap_funs = (function wrap_funs(fun_map){var render_fun = (function (){var or__3443__auto__ = new cljs.core.Keyword(null,"componentFunction","componentFunction",1139645287).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return new cljs.core.Keyword(null,"render","render",4374279432).cljs$core$IFn$_invoke$arity$1(fun_map);
}
})();var _ = ((reagent.impl.util.clj_ifn_QMARK_.call(null,render_fun))?null:(function(){throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str([cljs.core.str("Render must be a function, not "),cljs.core.str(cljs.core.pr_str.call(null,render_fun))].join('')),cljs.core.str("\n"),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol("util","clj-ifn?","util/clj-ifn?",-520791343,null),new cljs.core.Symbol(null,"render-fun","render-fun",-447610239,null))))].join('')))})());var name = (function (){var or__3443__auto__ = new cljs.core.Keyword(null,"displayName","displayName",2728053215).cljs$core$IFn$_invoke$arity$1(fun_map);if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = render_fun.displayName;if(cljs.core.truth_(or__3443__auto____$1))
{return or__3443__auto____$1;
} else
{return render_fun.name;
}
}
})();var name_SINGLEQUOTE_ = ((cljs.core.empty_QMARK_.call(null,name))?[cljs.core.str(cljs.core.gensym.call(null,"reagent"))].join(''):name);var fmap = reagent.impl.component.add_render.call(null,cljs.core.assoc.call(null,fun_map,new cljs.core.Keyword(null,"displayName","displayName",2728053215),name_SINGLEQUOTE_),render_fun);return cljs.core.reduce_kv.call(null,(function (m,k,v){return cljs.core.assoc.call(null,m,k,reagent.impl.component.get_wrapper.call(null,k,v,name_SINGLEQUOTE_));
}),cljs.core.PersistentArrayMap.EMPTY,fmap);
});
reagent.impl.component.map_to_js = (function map_to_js(m){return cljs.core.reduce_kv.call(null,(function (o,k,v){var G__6109 = o;(G__6109[cljs.core.name.call(null,k)] = v);
return G__6109;
}),{},m);
});
...
return (function() { 
var G__6110__delegate = function (args){return as_component.call(null,cljs.core.apply.call(null,cljs.core.vector,res,args));
};
var G__6110 = function (var_args){
var args = null;if (arguments.length > 0) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0),0);} 
return G__6110__delegate.call(this,args);};
G__6110.cljs$lang$maxFixedArity = 0;
G__6110.cljs$lang$applyTo = (function (arglist__6111){
var args = cljs.core.seq(arglist__6111);
return G__6110__delegate(args);
});
