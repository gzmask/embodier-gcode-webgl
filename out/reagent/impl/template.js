...
{return (function() { 
var G__6112__delegate = function (args){return cljs.core.apply.call(null,v,args);
};
...
{return cljs.core.reduce_kv.call(null,(function (res,k,v){var G__6115 = res;(G__6115[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.to_js_val.call(null,v));
return G__6115;
}),{},val);
} else
...
reagent.impl.template.set_id_class = (function set_id_class(props,p__6116){var vec__6118 = p__6116;var id = cljs.core.nth.call(null,vec__6118,0,null);var class$ = cljs.core.nth.call(null,vec__6118,1,null);var pid = (props["id"]);(props["id"] = ((!((pid == null)))?pid:id));
if((class$ == null))
{return null;
} else
...
{if(new cljs.core.Keyword(null,"else","else",1017020587))
{var objprops = cljs.core.reduce_kv.call(null,(function (o,k,v){var pname_6119 = reagent.impl.template.cached_prop_name.call(null,k);if(!((pname_6119 === "key")))
{(o[pname_6119] = reagent.impl.template.convert_prop_value.call(null,v));
} else
{}
return o;
...
var G__6122 = jsprops;(G__6122["defaultValue"] = value);
(G__6122["value"] = null);
(G__6122["onChange"] = (function (p1__6120_SHARP_){return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__6120_SHARP_);
}));
return G__6122;
}
});
...
reagent.impl.template.add_input_methods = (function add_input_methods(spec){var G__6124 = spec;(G__6124["componentDidUpdate"] = (function (){var C = this;return reagent.impl.template.input_did_update.call(null,C);
}));
(G__6124["componentWillUnmount"] = (function (){var C = this;return reagent.impl.batching.dispose.call(null,C);
}));
return G__6124;
});
...
return (function (p1__6125_SHARP_,p2__6126_SHARP_){var C = this;return reagent.impl.template.wrapped_should_update.call(null,C,p1__6125_SHARP_,p2__6126_SHARP_);
...
reagent.impl.template.parse_tag = (function parse_tag(hiccup_tag){var vec__6128 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));var tag = cljs.core.nth.call(null,vec__6128,0,null);var id = cljs.core.nth.call(null,vec__6128,1,null);var class$ = cljs.core.nth.call(null,vec__6128,2,null);var comp = (reagent.impl.template.DOM[tag]);var class_SINGLEQUOTE_ = (cljs.core.truth_(class$)?clojure.string.replace.call(null,class$,/\./," "):null);if(cljs.core.truth_(comp))
{} else
...
reagent.impl.template.get_wrapper = (function get_wrapper(tag){var vec__6130 = reagent.impl.template.parse_tag.call(null,tag);var comp = cljs.core.nth.call(null,vec__6130,0,null);var id_class = cljs.core.nth.call(null,vec__6130,1,null);return reagent.impl.template.wrap_component.call(null,comp,id_class,[cljs.core.str(tag)].join(''));
});
...
var c = reagent.impl.template.as_class.call(null,cljs.core.nth.call(null,v,0));var jsprops = (function (){var obj6134 = {};(obj6134[reagent.impl.util.cljs_argv] = v);
(obj6134[reagent.impl.util.cljs_level] = level);
return obj6134;
})();var k_6135 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,v));var k_SINGLEQUOTE__6136 = (((k_6135 == null))?reagent.impl.template.get_key.call(null,cljs.core.nth.call(null,v,1,null)):k_6135);if((k_SINGLEQUOTE__6136 == null))
{} else
{(jsprops["key"] = k_SINGLEQUOTE__6136);
}
...
reagent.impl.template.expand_seq = (function expand_seq(s,level){var a = cljs.core.into_array.call(null,s);var level_SINGLEQUOTE_ = (level + 1);var n__4291__auto___6137 = a.length;var i_6138 = 0;while(true){
if((i_6138 < n__4291__auto___6137))
{(a[i_6138] = reagent.impl.template.as_component.call(null,(a[i_6138]),level_SINGLEQUOTE_));
{
var G__6139 = (i_6138 + 1);
i_6138 = G__6139;
continue;
}
} else
...
reagent.impl.template.convert_args = (function convert_args(argv,first_child,level){var a = cljs.core.into_array.call(null,argv);var n__4291__auto___6140 = a.length;var i_6141 = 0;while(true){
if((i_6141 < n__4291__auto___6140))
{if((i_6141 >= first_child))
{(a[i_6141] = reagent.impl.template.as_component.call(null,(a[i_6141]),level));
} else
{}
{
