...
goog.require('clojure.string');
secretary.core.IRouteMatches = (function (){var obj5031 = {};return obj5031;
})();
...
secretary.core.IRouteValue = (function (){var obj5033 = {};return obj5033;
})();
secretary.core.route_value = (function route_value(this$){if((function (){var and__3431__auto__ = this$;if(and__3431__auto__)
...
{var x__4070__auto__ = (((this$ == null))?null:this$);return (function (){var or__3443__auto__ = (secretary.core.route_value[goog.typeOf(x__4070__auto__)]);if(or__3443__auto__)
{return or__3443__auto__;
} else
{var or__3443__auto____$1 = (secretary.core.route_value["_"]);if(or__3443__auto____$1)
{return or__3443__auto____$1;
} else
...
secretary.core.IRenderRoute = (function (){var obj5035 = {};return obj5035;
})();
...
;
cljs.core._add_method.call(null,secretary.core.encode_pair,new cljs.core.Keyword("secretary.core","sequential","secretary.core/sequential",1410725665),(function (p__5040){var vec__5041 = p__5040;var k = cljs.core.nth.call(null,vec__5041,0,null);var v = cljs.core.nth.call(null,vec__5041,1,null);var encoded = cljs.core.map_indexed.call(null,(function (i,x){var pair = ((cljs.core.coll_QMARK_.call(null,x))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [secretary.core.key_index.call(null,k,i),x], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [secretary.core.key_index.call(null,k),x], null));return secretary.core.encode_pair.call(null,pair);
}),v);return clojure.string.join.call(null,"&",encoded);
}));
cljs.core._add_method.call(null,secretary.core.encode_pair,new cljs.core.Keyword("secretary.core","map","secretary.core/map",572371848),(function (p__5042){var vec__5043 = p__5042;var k = cljs.core.nth.call(null,vec__5043,0,null);var v = cljs.core.nth.call(null,vec__5043,1,null);var encoded = cljs.core.map.call(null,(function (p__5044){var vec__5045 = p__5044;var ik = cljs.core.nth.call(null,vec__5045,0,null);var iv = cljs.core.nth.call(null,vec__5045,1,null);return secretary.core.encode_pair.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [secretary.core.key_index.call(null,k,cljs.core.name.call(null,ik)),iv], null));
}),v);return clojure.string.join.call(null,"&",encoded);
}));
cljs.core._add_method.call(null,secretary.core.encode_pair,new cljs.core.Keyword(null,"default","default",2558708147),(function (p__5046){var vec__5047 = p__5046;var k = cljs.core.nth.call(null,vec__5047,0,null);var v = cljs.core.nth.call(null,vec__5047,1,null);return [cljs.core.str(cljs.core.name.call(null,k)),cljs.core.str("="),cljs.core.str(secretary.core.encode.call(null,[cljs.core.str(v)].join('')))].join('');
}));
/**
...
*/
secretary.core.parse_path = (function parse_path(path){var index_re = /\[([^\]]*)\]*/;var parts = cljs.core.re_seq.call(null,index_re,path);return cljs.core.map.call(null,(function (p__5050){var vec__5051 = p__5050;var _ = cljs.core.nth.call(null,vec__5051,0,null);var part = cljs.core.nth.call(null,vec__5051,1,null);if(cljs.core.empty_QMARK_.call(null,part))
{return 0;
} else
...
* 
*/
secretary.core.key_parse = (function key_parse(k){var re = /([^\[\]]+)((?:\[[^\]]*\])*)?/;var vec__5053 = cljs.core.re_matches.call(null,re,k);var _ = cljs.core.nth.call(null,vec__5053,0,null);var key = cljs.core.nth.call(null,vec__5053,1,null);var path = cljs.core.nth.call(null,vec__5053,2,null);var parsed_path = (cljs.core.truth_(path)?secretary.core.parse_path.call(null,path):null);return cljs.core.cons.call(null,key,parsed_path);
});
/**
...
return (function (m,part){var vec__5055 = clojure.string.split.call(null,part,/=/,2);var k = cljs.core.nth.call(null,vec__5055,0,null);var v = cljs.core.nth.call(null,vec__5055,1,null);return secretary.core.assoc_in_query_params.call(null,m,secretary.core.key_parse.call(null,k),secretary.core.decode.call(null,v));
});})(parts))
...
*/
secretary.core.lex_STAR_ = (function lex_STAR_(s,clauses){return cljs.core.some.call(null,(function (p__5059){var vec__5060 = p__5059;var re = cljs.core.nth.call(null,vec__5060,0,null);var action = cljs.core.nth.call(null,vec__5060,1,null);var temp__4092__auto__ = cljs.core.re_find.call(null,re,s);if(cljs.core.truth_(temp__4092__auto__))
{var vec__5061 = temp__4092__auto__;var m = cljs.core.nth.call(null,vec__5061,0,null);var c = cljs.core.nth.call(null,vec__5061,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,s,cljs.core.count.call(null,m)),action.call(null,c)], null);
} else
{return null;
}
}),clauses);
...
{var vec__5064 = secretary.core.lex_STAR_.call(null,s__$1,clauses);var s__$2 = cljs.core.nth.call(null,vec__5064,0,null);var vec__5065 = cljs.core.nth.call(null,vec__5064,1,null);var r = cljs.core.nth.call(null,vec__5065,0,null);var p = cljs.core.nth.call(null,vec__5065,1,null);{
var G__5066 = s__$2;
var G__5067 = [cljs.core.str(pattern),cljs.core.str(r)].join('');
var G__5068 = cljs.core.conj.call(null,params,p);
s__$1 = G__5066;
pattern = G__5067;
params = G__5068;
continue;
...
})], null)], null);var vec__5074 = secretary.core.lex_route.call(null,orig_route,clauses);var re = cljs.core.nth.call(null,vec__5074,0,null);var params = cljs.core.nth.call(null,vec__5074,1,null);if(typeof secretary.core.t5075 !== 'undefined')
{} else
{
/**
* @constructor
*/
secretary.core.t5075 = (function (params,re,vec__5074,clauses,orig_route,compile_route,meta5076){
this.params = params;
this.re = re;
this.vec__5074 = vec__5074;
this.clauses = clauses;
this.orig_route = orig_route;
this.compile_route = compile_route;
this.meta5076 = meta5076;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 393216;
})
secretary.core.t5075.cljs$lang$type = true;
secretary.core.t5075.cljs$lang$ctorStr = "secretary.core/t5075";
secretary.core.t5075.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"secretary.core/t5075");
});
secretary.core.t5075.prototype.secretary$core$IRouteMatches$ = true;
secretary.core.t5075.prototype.secretary$core$IRouteMatches$route_matches$arity$2 = (function (_,route){var self__ = this;
...
{var vec__5078 = temp__4092__auto__;var ___$2 = cljs.core.nth.call(null,vec__5078,0,null);var ms = cljs.core.nthnext.call(null,vec__5078,1);return cljs.core.merge_with.call(null,cljs.core.vector,cljs.core.PersistentArrayMap.EMPTY,cljs.core.partition.call(null,2,cljs.core.interleave.call(null,self__.params,cljs.core.map.call(null,secretary.core.decode,ms))));
} else
{return null;
}
});
secretary.core.t5075.prototype.secretary$core$IRouteValue$ = true;
secretary.core.t5075.prototype.secretary$core$IRouteValue$route_value$arity$1 = (function (this$){var self__ = this;
var this$__$1 = this;return self__.orig_route;
});
secretary.core.t5075.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_5077){var self__ = this;
var _5077__$1 = this;return self__.meta5076;
});
secretary.core.t5075.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_5077,meta5076__$1){var self__ = this;
var _5077__$1 = this;return (new secretary.core.t5075(self__.params,self__.re,self__.vec__5074,self__.clauses,self__.orig_route,self__.compile_route,meta5076__$1));
});
secretary.core.__GT_t5075 = (function __GT_t5075(params__$1,re__$1,vec__5074__$1,clauses__$1,orig_route__$1,compile_route__$1,meta5076){return (new secretary.core.t5075(params__$1,re__$1,vec__5074__$1,clauses__$1,orig_route__$1,compile_route__$1,meta5076));
});
}
return (new secretary.core.t5075(params,re,vec__5074,clauses,orig_route,compile_route,null));
});
/**
* @param {...*} var_args
*/
secretary.core.render_route_STAR_ = (function() { 
var render_route_STAR___delegate = function (obj,args){if((function (){var G__5080 = obj;if(G__5080)
{var bit__4093__auto__ = null;if(cljs.core.truth_((function (){var or__3443__auto__ = bit__4093__auto__;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
{return G__5080.secretary$core$IRenderRoute$;
}
})()))
{return true;
} else
{if((!G__5080.cljs$lang$protocol_mask$partition$))
{return cljs.core.native_satisfies_QMARK_.call(null,secretary.core.IRenderRoute,G__5080);
} else
{return false;
}
}
...
render_route_STAR_.cljs$lang$applyTo = (function (arglist__5081){
var obj = cljs.core.first(arglist__5081);
var args = cljs.core.rest(arglist__5081);
...
secretary.core.remove_route_BANG_ = (function remove_route_BANG_(obj){return cljs.core.swap_BANG_.call(null,secretary.core._STAR_routes_STAR_,(function (rs){return cljs.core.filterv.call(null,(function (p__5084){var vec__5085 = p__5084;var x = cljs.core.nth.call(null,vec__5085,0,null);var _ = cljs.core.nth.call(null,vec__5085,1,null);return cljs.core.not_EQ_.call(null,x,obj);
}),rs);
}));
});
...
secretary.core.locate_route = (function locate_route(route){return cljs.core.some.call(null,(function (p__5088){var vec__5089 = p__5088;var compiled_route = cljs.core.nth.call(null,vec__5089,0,null);var action = cljs.core.nth.call(null,vec__5089,1,null);var temp__4092__auto__ = secretary.core.route_matches.call(null,compiled_route,route);if(cljs.core.truth_(temp__4092__auto__))
...
*/
secretary.core.dispatch_BANG_ = (function dispatch_BANG_(uri){var vec__5092 = clojure.string.split.call(null,uri,/\?/);var uri_path = cljs.core.nth.call(null,vec__5092,0,null);var query_string = cljs.core.nth.call(null,vec__5092,1,null);var query_params = (cljs.core.truth_(query_string)?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"query-params","query-params",1080249757),secretary.core.decode_query_params.call(null,query_string)], null):null);var map__5093 = secretary.core.locate_route.call(null,uri_path);var map__5093__$1 = ((cljs.core.seq_QMARK_.call(null,map__5093))?cljs.core.apply.call(null,cljs.core.hash_map,map__5093):map__5093);var params = cljs.core.get.call(null,map__5093__$1,new cljs.core.Keyword(null,"params","params",4313443576));var action = cljs.core.get.call(null,map__5093__$1,new cljs.core.Keyword(null,"action","action",3885920680));var action__$1 = (function (){var or__3443__auto__ = action;if(cljs.core.truth_(or__3443__auto__))
{return or__3443__auto__;
} else
...
{var vec__5094 = temp__4092__auto__;var _ = cljs.core.nth.call(null,vec__5094,0,null);var ms = cljs.core.nthnext.call(null,vec__5094,1);return cljs.core.vec.call(null,ms);
} else
{return null;
}
});
...
(secretary.core.render_route["string"] = (function (this$,params){var map__5095 = params;var map__5095__$1 = ((cljs.core.seq_QMARK_.call(null,map__5095))?cljs.core.apply.call(null,cljs.core.hash_map,map__5095):map__5095);var m = map__5095__$1;var query_params = cljs.core.get.call(null,map__5095__$1,new cljs.core.Keyword(null,"query-params","query-params",1080249757));var a = cljs.core.atom.call(null,m);var path = this$.replace((new RegExp(":[^\\s.:*/]+|\\*[^\\s.:*/]*","g")),((function (map__5095,map__5095__$1,m,query_params,a){
...
});})(map__5095,map__5095__$1,m,query_params,a))
