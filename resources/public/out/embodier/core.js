...
embodier.core.upload_button = (function upload_button(){return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"button#upload-button","button#upload-button",2858032223),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"style","style",1123684643),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"color","color",1108746965),"#555"], null)], null),"upload file"], null);
});
...
embodier.core.control_range_BANG_ = (function control_range_BANG_(name,min,max){var layer = reagent.core.atom.call(null,min);return (function (){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-md-12","div.col-md-12",4752778719),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.input-group","div.input-group",4171284561),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.input-group-addon","span.input-group-addon",2295458237),name,": ",cljs.core.deref.call(null,layer)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",1114262332),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1017479852),"range",new cljs.core.Keyword(null,"name","name",1017277949),name,new cljs.core.Keyword(null,"value","value",1125876963),cljs.core.deref.call(null,layer),new cljs.core.Keyword(null,"on-change","on-change",606853840),(function (p1__6590_SHARP_){return cljs.core.reset_BANG_.call(null,layer,p1__6590_SHARP_.target.value);
...
embodier.core.app = (function app(){return new cljs.core.PersistentVector(null, 12, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1014003715),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [embodier.core.header], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",1013904339),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",1017115293),"#/"], null),"home"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",1013907394)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",1013904339),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",1017115293),"#/upload"], null),"upload"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",1013907394)], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"a","a",1013904339),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"href","href",1017115293),"#/layers"], null),"layers"], null),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",1013907394)], null),(function (){var iter__4160__auto__ = (function iter__6595(s__6596){return (new cljs.core.LazySeq(null,(function (){var s__6596__$1 = s__6596;while(true){
var temp__4092__auto__ = cljs.core.seq.call(null,s__6596__$1);if(temp__4092__auto__)
{var s__6596__$2 = temp__4092__auto__;if(cljs.core.chunked_seq_QMARK_.call(null,s__6596__$2))
{var c__4158__auto__ = cljs.core.chunk_first.call(null,s__6596__$2);var size__4159__auto__ = cljs.core.count.call(null,c__4158__auto__);var b__6598 = cljs.core.chunk_buffer.call(null,size__4159__auto__);if((function (){var i__6597 = 0;while(true){
if((i__6597 < size__4159__auto__))
{var x = cljs.core._nth.call(null,c__4158__auto__,i__6597);cljs.core.chunk_append.call(null,b__6598,cljs.core.with_meta(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",1013907394)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",1014010321),x], null)));
{
var G__6599 = (i__6597 + 1);
i__6597 = G__6599;
continue;
}
} else
...
{var x = cljs.core.first.call(null,s__6596__$2);return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"br","br",1013907394)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",1014010321),x], null)),iter__6595.call(null,cljs.core.rest.call(null,s__6596__$2)));
}
} else
{return null;
}
...
var action__4367__auto___6602 = (function (params__4368__auto__){if(cljs.core.map_QMARK_.call(null,params__4368__auto__))
{var map__6600 = params__4368__auto__;var map__6600__$1 = ((cljs.core.seq_QMARK_.call(null,map__6600))?cljs.core.apply.call(null,cljs.core.hash_map,map__6600):map__6600);return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),true], null));
} else
{if(cljs.core.vector_QMARK_.call(null,params__4368__auto__))
{var vec__6601 = params__4368__auto__;return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),true], null));
} else
{return null;
}
}
});secretary.core.add_route_BANG_.call(null,"/upload",action__4367__auto___6602);
var action__4367__auto___6605 = (function (params__4368__auto__){if(cljs.core.map_QMARK_.call(null,params__4368__auto__))
{var map__6603 = params__4368__auto__;var map__6603__$1 = ((cljs.core.seq_QMARK_.call(null,map__6603))?cljs.core.apply.call(null,cljs.core.hash_map,map__6603):map__6603);return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),true,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{if(cljs.core.vector_QMARK_.call(null,params__4368__auto__))
{var vec__6604 = params__4368__auto__;return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),true,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{return null;
}
}
});secretary.core.add_route_BANG_.call(null,"/layers",action__4367__auto___6605);
var action__4367__auto___6608 = (function (params__4368__auto__){if(cljs.core.map_QMARK_.call(null,params__4368__auto__))
{var map__6606 = params__4368__auto__;var map__6606__$1 = ((cljs.core.seq_QMARK_.call(null,map__6606))?cljs.core.apply.call(null,cljs.core.hash_map,map__6606):map__6606);return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{if(cljs.core.vector_QMARK_.call(null,params__4368__auto__))
{var vec__6607 = params__4368__auto__;return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{return null;
}
}
});secretary.core.add_route_BANG_.call(null,"/",action__4367__auto___6608);
