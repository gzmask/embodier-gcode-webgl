...
embodier.core.control_range_BANG_ = (function control_range_BANG_(name,min,max){var layer = reagent.core.atom.call(null,min);return (function (){return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.col-md-12","div.col-md-12",4752778719),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.input-group","div.input-group",4171284561),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span.input-group-addon","span.input-group-addon",2295458237),name,": ",cljs.core.deref.call(null,layer)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",1114262332),new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"type","type",1017479852),"range",new cljs.core.Keyword(null,"name","name",1017277949),name,new cljs.core.Keyword(null,"value","value",1125876963),cljs.core.deref.call(null,layer),new cljs.core.Keyword(null,"on-change","on-change",606853840),(function (p1__5674_SHARP_){return cljs.core.reset_BANG_.call(null,layer,p1__5674_SHARP_.target.value);
...
var action__4367__auto___5686 = (function (params__4368__auto__){if(cljs.core.map_QMARK_.call(null,params__4368__auto__))
{var map__5684 = params__4368__auto__;var map__5684__$1 = ((cljs.core.seq_QMARK_.call(null,map__5684))?cljs.core.apply.call(null,cljs.core.hash_map,map__5684):map__5684);return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),true], null));
} else
{if(cljs.core.vector_QMARK_.call(null,params__4368__auto__))
{var vec__5685 = params__4368__auto__;return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),true], null));
} else
{return null;
}
}
});secretary.core.add_route_BANG_.call(null,"/upload",action__4367__auto___5686);
var action__4367__auto___5689 = (function (params__4368__auto__){if(cljs.core.map_QMARK_.call(null,params__4368__auto__))
{var map__5687 = params__4368__auto__;var map__5687__$1 = ((cljs.core.seq_QMARK_.call(null,map__5687))?cljs.core.apply.call(null,cljs.core.hash_map,map__5687):map__5687);return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),true,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{if(cljs.core.vector_QMARK_.call(null,params__4368__auto__))
{var vec__5688 = params__4368__auto__;return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),true,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{return null;
}
}
});secretary.core.add_route_BANG_.call(null,"/layers",action__4367__auto___5689);
var action__4367__auto___5692 = (function (params__4368__auto__){if(cljs.core.map_QMARK_.call(null,params__4368__auto__))
{var map__5690 = params__4368__auto__;var map__5690__$1 = ((cljs.core.seq_QMARK_.call(null,map__5690))?cljs.core.apply.call(null,cljs.core.hash_map,map__5690):map__5690);return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{if(cljs.core.vector_QMARK_.call(null,params__4368__auto__))
{var vec__5691 = params__4368__auto__;return cljs.core.reset_BANG_.call(null,embodier.core.routes,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"layer-view","layer-view",920003859),false,new cljs.core.Keyword(null,"upload-file","upload-file",2032309562),false], null));
} else
{return null;
}
}
});secretary.core.add_route_BANG_.call(null,"/",action__4367__auto___5692);
